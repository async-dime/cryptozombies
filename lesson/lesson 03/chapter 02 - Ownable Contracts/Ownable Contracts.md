...
Below is the `Ownable` contract taken from the [**OpenZeppelin**](https://openzeppelin.com/) Solidity library. OpenZeppelin is a library of secure and community-vetted smart contracts that you can use in your own DApps. After this lesson, we highly recommend you check out their site to further your learning!
